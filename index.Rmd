...
###Selecionamos a Melanoxylon brauna, uma espécie vegetal endêmica do Brasil pertencente a família fabaceae.
...
```
#Após 294 conferir o número de linhas e colunas do seu objeto, teremos que conferir o nome das colunas dentro desse dataset
...
#Temos  variáveis, mas com a função distinct do pacote dplyr conseguimos avaliar quais dessas são únicas.
